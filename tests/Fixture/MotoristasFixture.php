...
class MotoristasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cnh' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2021-12-05 04:35:22',
                'modified' => '2021-12-05 04:35:22',
            ],
        ];
        parent::init();
    }
